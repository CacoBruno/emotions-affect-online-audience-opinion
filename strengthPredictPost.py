...
# Load trained lexicon for posts
...
def sentimentStrengthPost(text):
    ...
    Args:
        ...
        tokenizer: The tokenizer used in training.
        lexicon: The lexicon with sentiment scores.
        max_sequence_length: The maximum sequence length used in training.
    ...
    return {
        "text": text,
        "strengthPredict": float(prediction[0][0])  # Convert to Python type
    }
